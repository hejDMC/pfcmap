...
#We have only PFC regions for now and no rois
'''
...
'''
print('pfc: areas',np.unique([U.area for U in Units]))
...
reftag, Usel = 'refall',Units

statsdict[reftag]['nolays'] = matchfns.get_all_shuffs(Usel,'roistrreg',attr2,const_attr=const_attr,nshuff=nshuff,signif_levels=signif_levels)
